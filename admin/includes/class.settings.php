...
class SpeedGuard_Settings {
    ...
    function __construct() {
        ...
        add_action(
            'added_option',
            [$this, 'default_options_added'],
            10,
            2
        );
        add_action(
            'updated_option',
            [$this, 'speedguard_options_updated'],
            10,
            3
        );
        add_action(
            'pre_update_option_speedguard_options',
            [$this, 'default_options_set'],
            10,
            2
        );
        ...
        add_action(
            'pre_update_site_option_speedguard_options',
            [$this, 'default_options_set'],
            10,
            2
        );
    ...
    public static function settings_page_function() {
        if ( SpeedGuard_Admin::is_screen( 'settings' ) ) {
            ...
            <div class="wrap">
                <h2><?php 
            esc_html_e( 'SpeedGuard :: Settings', 'speedguard' );
            ?></h2>
            ...
            ?>
                    ...
                    <div id="post-body" class="has-sidebar">
                        <div id="post-body-content" class="has-sidebar-content">
                            <form method="post"
                                  action="<?php 
            echo esc_url( ( defined( 'SPEEDGUARD_MU_NETWORK' ) ? 'edit.php?action=speedguard_update_settings' : 'options.php' ) );
            ?>">
								<?php 
    ...
    function default_options_added( $option, $new_value ) {
        ...
        } elseif ( !empty( $speedguard_options ) && $option === 'speedguard_options' ) {
            // if updating options
            $speedguard_options = SpeedGuard_Admin::get_this_plugin_option( 'speedguard_options' );
    ...
    function speedguard_settings() {
        ...
        add_settings_section(
            ...
            __( 'Email notification in case your CWV needs your attention:', 'speedguard' ),
            [$this, 'notifications_description_fn'],
            'speedguard'
        );
    }
